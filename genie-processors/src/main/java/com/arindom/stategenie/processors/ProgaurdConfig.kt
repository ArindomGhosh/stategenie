...
internal data class ProgaurdConfig(
  ...
  private val targetClassKind: ClassKind,
  ...
  internal fun writeTo(out: Appendable): Unit =
    out.run {
      ...
      // Keep the class or interface name for StateGenie's reflective lookup based on it
      ...
      // Keep the constructor for StateGenie's reflective lookup
